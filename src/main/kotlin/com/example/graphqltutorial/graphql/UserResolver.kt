...
@Component
class UserResolver(val tripRepository: TripRepository, val userRepository: UserRepository): GraphQLResolver<UserCandidate> {


    fun createdTrips(user: UserCandidate) =
    ...
    fun birthDate(user: UserCandidate): LocalDate? =

...
class TripRepository {
    ...
    private fun init(): ArrayList<TripDto> {
    ...
    fun updatePlace(tripId: String, newPlace: String): String {
        this.trips.find { it.id == tripId }!!.let {
            trips.remove(it)
            it.place = newPlace
            return addTrip(it)
        }
